                            ...
                            <table>
                                ...
                                <tbody>
                                    {features.map(feature => {
                                        const presentCount = data.packs.filter(pack => (pack.categories[categoryName] || []).includes(feature)).length;
                                        return (
                                            <tr key={feature}>
                                                <td>{feature}</td>
                                                {data.packs.map(pack => {
                                                    const inPack = (pack.categories[categoryName] || []).includes(feature);
